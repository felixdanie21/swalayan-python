...
class Mbarang(models.Model):
    ...
    barangstokmin = models.FloatField(null=True)
    barangaktif = models.CharField(max_length=1)
    barangstokmaks = models.FloatField(null=True)
    barangpoinqty = models.FloatField(null=True)
    barangpoinomz = models.FloatField(null=True)
    barangdscmember = models.FloatField(null=True)
    barangstatbonus = models.CharField(max_length=1, null=True)
    ...
    barangdisc = models.FloatField(null=True)
