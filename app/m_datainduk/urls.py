...
urlpatterns = [
    ...
    path('msup_supplier',views.msup_supplier, name='msup_supplier'),
    path('msup_supplier_form/<str:method>',views.msup_supplier_form, name='msup_supplier_form'),
    path('msup_supplier_post/<str:method>',views.msup_supplier_post, name='msup_supplier_post'),
    path('msup_supplier_delete/<str:supplierkode>',views.msup_supplier_delete, name='msup_supplier_delete'),
    path('msup_barang', views.msup_barang, name='msup_barang'),
    path('msup_barang_form/<str:method>', views.msup_barang_form, name='msup_barang_form'),
    path('msup_barang_post/<str:method>', views.msup_barang_post, name='msup_barang_post'),
    path('msup_barang_delete/<str:supplierkode>', views.msup_barang_delete, name='msup_barang_delete'),
    path('memb_datamember', blank, name='memb_datamember'),
    path('memb_datamember/<str:method>', blank, name='memb_datamember_form'),
    path('memb_datamember/<str:method>', blank, name='memb_datamember_post'),
    path('memb_datamember', blank, name='memb_datamember_delete'),
    path('memb_poinbarang', blank, name='memb_poinbarang'),
    path('memb_poinbarang_form/<str:method>', blank, name='memb_poinbarang_form'),
    path('memb_poinbarang_post/<str:method>', blank, name='memb_poinbarang_post'),
    path('memb_poinbarang_delete', blank, name='memb_poinbarang_delete'),
